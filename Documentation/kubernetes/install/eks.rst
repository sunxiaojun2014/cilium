...
#. Assign a fixed security identity to ``kube-dns`` by editing the deployment and adding the label ``io.cilium.fixed-identity: kube-dns``
   ...
   security policies before etcd is up.
